...
public class Affichage {
	...
	*/
	...
	private void initialize() {
		...
		Generateur_CV rb=new Generateur_CV();
		...
		JButton btnView = new JButton("Enregistrer");
		...
		JLabel lblSo = new JLabel("prenom:");
		lblSo.setFont(new Font("Tahoma", Font.BOLD, 10));
		lblSo.setBounds(6, 85, 60, 15);
		panel.add(lblSo);
		...
		lblAcademicQualification.setFont(new Font("Arial", Font.BOLD, 20));
		lblAcademicQualification.setBackground(Color.WHITE);
		lblAcademicQualification.setBounds(50,300, 421, 31);
		...
		JLabel lblGrade = new JLabel("Montion:");
		...
		JLabel lblGraduation = new JLabel("BAC:");
		lblGraduation.setForeground(Color.RED);
		lblGraduation.setFont(new Font("Arial", Font.BOLD, 16));
		lblGraduation.setBounds(110, 387, 94, 23);
		...
		JLabel lblIntermediate = new JLabel("LICENCE:");
		lblIntermediate.setForeground(Color.RED);
		lblIntermediate.setFont(new Font("Arial", Font.BOLD, 16));
		...
		lblMatriculation.setFont(new Font("Arial", Font.BOLD, 16));
		...
		JLabel lblSkills = new JLabel("INFORMATIQUE:");
		lblSkills.setForeground(Color.BLUE);
		lblSkills.setFont(new Font("Arial", Font.BOLD, 20));
		...
		lblLanguages.setFont(new Font("Arial", Font.BOLD, 20));
		lblLanguages.setBackground(Color.WHITE);
		lblLanguages.setBounds(50, 631, 210, 31);
		panel.add(lblLanguages);
		
		JLabel lblSports = new JLabel("SPORTS:");
		lblSports.setForeground(Color.BLUE);
		lblSports.setFont(new Font("Arial", Font.BOLD, 20));
		...
		lblDob = new JLabel("D.D.N ");
		lblDob.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblDob.setBounds(5, 114, 37, 14);
		panel.add(lblDob);
		...
		panel.add(Dob);
		Generateur_CV r = new Generateur_CV();
		label = new JLabel("");
